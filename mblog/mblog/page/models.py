...
class Category(BaseModel):
    name = models.CharField(max_length=100, default=u'未分类', unique=True,
                            verbose_name=u'名称')
    nav_name = models.CharField(max_length=100, verbose_name=u'导航名', blank=True)
    ...
    def get_absolute_url(self):
        return ('page.get', [], dict(cate=self.id))
...
class Entry(BaseModel):
    ...
    in_top = models.BooleanField(verbose_name=u'顶置推荐', default=False)
